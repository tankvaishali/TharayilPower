        ...
        <div className="container py-3 pb-lg-5 my-5 overflow-hidden">
          ...
          <div className="row p-0 m-0 pt-4">
            <div className="col-12 col-lg-4 mt-3 mt-lg-5 ">
              ...
              >
                <div>
                  ...
                  <div className="pera ">
                    Backed by the trust of 1200+ satisfied clients, we deliver
                    proven energy solutions.
                  </div>
                  <div className="fw-bold text-success fs-5 pt-2 pt-lg-3 ">
                    Reliable Services:
                  </div>
                  <div className="pera ">
                    We prioritize quality and consistency in every project we
                    undertake.
                  </div>
                  <div className="fw-bold text-success fs-5 pt-2 pt-lg-3 ">
                    {" "}
                  ...
                  <div className="pera ">
                    Our innovative products are designed to maximize performance
            ...
            <div className="col-12 col-lg-4  mt-3 mt-lg-5 ">
              ...
              >
                <img
                  src={require("../../Assets/Images/why-choose.png")}
                  alt="not found"
            ...
            <div className="col-12 col-lg-4 mt-3 ps-0 ps-lg-5">
              ...
              >
                ...
                <div>
                  ...
                  <div className="pera ">
                    Helping you embrace a greener future with eco-friendly,
                ...
                <div>
                  ...
                  <div className="pera ">
                    A clear proposal outlines product options, system
                    configurations, cost estimates, giving you confidence in
                    your investment.
                  </div>
                </div>
                <div className="pt-2">
